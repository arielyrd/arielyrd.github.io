          ...
          {skills.map((skill, index) => (
            ...
            >
              <div className="relative w-16 h-16 mb-2">
                <div className="absolute inset-0 bg-accent-primary/20 rounded-lg filter blur-xl group-hover:blur-2xl transition-all duration-300"></div>
                <img
                  src={skill.icon}
                  alt={skill.name}
              ...
              <span className="mt-2 text-sm text-gray-400 group-hover:text-accent-primary transition-colors">
                {skill.name}
              </span>
            </motion.div>
          ))}
